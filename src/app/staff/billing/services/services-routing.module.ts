...
import { ServiceUpgradeOptionsResolver } from '@fleio-api/billing/services/service-upgrade-options.resolver';
...
const routes: Routes = [
  ...
  },
  {
    ...
    component: ServiceChangeOptionsComponent,
    resolve: {
      service: ServiceResolver,
      upgradeOptions: ServiceUpgradeOptionsResolver,
    },
    data: {
      config: {
        getBreadCrumbDetail: (data) => {
  ...
  {
    path: ':id/change-product',
    component: ServiceChangeProductComponent,
    resolve: {
      service: ServiceResolver,
      upgradeOptions: ServiceUpgradeOptionsResolver,
    },
