...
import { OpenstackPluginConfigurationComponent } from '../../plugins/openstack/openstack-plugin-configuration/openstack-plugin-configuration.component';
import { DomainsPluginConfigurationComponent } from '../../plugins/domains/domains-plugin-configuration/domains-plugin-configuration.component';
    ...
    const deleteAction = new ApiCallAction(
      {
        ...
        errorMessage: 'Failed to delete configuration, check logs for details',
      ...
      case 'details':
        return [
          ...
          },
          {
            ...
            component: OpenstackPluginConfigurationComponent,
          },
          {
            tabName: 'Domains',
            featureName: 'plugins.domains',
            component: DomainsPluginConfigurationComponent,
          },
        ];
      case 'create':
        return [
