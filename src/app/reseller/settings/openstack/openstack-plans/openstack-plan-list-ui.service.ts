    ...
    const tableData: ITableData = {
      header: {
        columns: [
          ...
          {type: ColumnType.Value, displayName: 'Currency', enableSort: true, fieldName: 'currency', hide: 'xs'},
          {type: ColumnType.Value, displayName: 'Is default', enableSort: false, fieldName: 'is_default'},
          {type: ColumnType.Actions, displayName: 'Actions', enableSort: false, fieldName: '(actions)', hide: 'xs'},
        ],
