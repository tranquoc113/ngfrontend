...
import { FlavorListResolver } from '../../../shared/fleio-api/openstack/flavor/flavor-list.resolver';
import { FlavorResolver } from '../../../shared/fleio-api/openstack/flavor/flavor.resolver';
import { FlavorPermissionsResolver } from '../../../shared/fleio-api/openstack/flavor/flavor-permissions.resolver';
import { FlavorCreateOptionsResolver } from '../../../shared/fleio-api/openstack/flavor/flavor-create-options.resolver';
      ...
      config: {
        ...
        filterConfig: {
          availableOptions: [
            ...
            // {
            //   display: 'Display for clients',
            //   field: 'display_for_clients',
            //   type: FilterTypes.Boolean
            // },
          ]
        }
